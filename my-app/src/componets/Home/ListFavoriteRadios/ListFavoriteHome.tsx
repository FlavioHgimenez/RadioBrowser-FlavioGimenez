...
const ListFavoriteHome = () => {
      ...
      return (
            <main className="bg-[#dde1ed] rounded-xl flex flex-col">
                  ...
                  <ul className="max-h-full overflow-y-scroll flex flex-col p-2 lg:p-4 gap-2">
                        {
                                          ...
                                          <div className="flex items-center gap-1 lg:gap-3">
                                                {favItem.url !== radioUrl &&
                                                      (
                                                            <button
                                                                  disabled={isLoading}
                                                                  className={`aspect-square rounded-full p-1 lg:p-2 cursor-pointer h-full bg-[#1b1b1b] ${isLoading ? "bg-gray-400" : "bg-[#1b1b1b]"}`}
                                                      ...
                                                      (
                                                            <button
                                                                  disabled={isLoading}
                                                                  className={`aspect-square rounded-full p-1 lg:p-2 cursor-pointer h-full  ${isLoading ? "bg-gray-200" : "bg-[#1b1b1b]"}`}
                                                                  onClick={stop}
                                                            >
                                                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="white" className="w-5 h-5 ">
                                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 7.5A2.25 2.25 0 017.5 5.25h9a2.25 2.25 0 012.25 2.25v9a2.25 2.25 0 01-2.25 2.25h-9a2.25 2.25 0 01-2.25-2.25v-9z" />
                                                ...
                                                {favItem.stationuuid === itemEdit && (
                                                      <div className="flex">
                                                            <input
                                                                  type="text"
                                                                  value={newName}
                                                                  className="bg-white shadow border w-full rounded-l-full lg:px-2"
                                                            ...
                                                            <p className="text-[12px] lg:text-[14px]">
                                                                  {favItem.name && favItem.name.replaceAll(" ", "").length > 0 ? favItem.name : "Sem Nome"}
                                                            </p>
                                                      )}
                                          </div>
                                          <div className="flex gap-3">
                                                <button
                                                      className="p-1 lg:p-2 rounded-lg bg-[#e3e3e3] hover:bg-[#d7d7d7]"
                                                ...
                                                <button
                                                      className="p-1 lg:p-2 rounded-lg bg-[#e3e3e3] hover:bg-[#d7d7d7]"
                                                      onClick={(e) => {
                                                            removeFavorite(favItem.stationuuid)
